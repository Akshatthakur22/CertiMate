...
export default function UploadPage() {
  ...
  return (
    <PageLayout>
      ...
      <motion.div 
        className="min-h-screen py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 bg-gradient-to-br from-white via-indigo-50/30 to-white"
      ...
      >
        <div className="container max-w-3xl mx-auto">
          ...
          {/* Upload success and transition message */}
          {file && !isUploading && (
            <motion.div
            ...
            >
              <div className="inline-flex flex-col items-center gap-2">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <span className="text-sm text-green-700 font-medium">Template uploaded</span>
                </div>
                {isTransitioning && (
